...
const { uploadReport, uploadLists, testAPI, getVideos, addOneLikes, addOneDislikes, addOneViews, getVideoByID, getVideoByTag, countVideoTags, getVideoByArtist, getVideoBySearchKey, getComments, getRelatedVideos, uploadComment, removeComment, addToWatchLater } = require('../controller/video')
...
router.post('/uploadReport', allowCors(uploadReport))
router.post('/uploadLists', allowCors(uploadLists))
router.get('/testAPI', allowCors(testAPI))
